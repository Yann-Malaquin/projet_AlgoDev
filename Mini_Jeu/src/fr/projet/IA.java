...
public class IA extends Joueur {
	...
	private int cpt;
	private int cptMemoire;
	private int point;
	
	public IA() {
		super();
		int tableauCoup[] = new int[201];
		int memoireCoups[] = new int[100];
		this.cpt = 1;
		this.cptMemoire = 0;
	}	
	...
	public int coupIA(IA IA, GrilleBN GrilleJoueur1, int[] tableauResult, int[] memoireCoups) {
		...
		boolean result = Partie.VerifCoup(CoorX, CoorY, GrilleJoueur1);
		if (result == true) {
