...
public class MenuPrincipal {
    ...
    public void affichageMenuPrincipal() {
        ...
        ImageIcon fond = new ImageIcon("src/Fond_Menu.jpg");
    ...
    private void afficherMenuJeux() {
        ImageIcon f = new ImageIcon("src/Fond_Jeux.jpg");
        ...
        Sudo.setIcon(new ImageIcon("src/Sudoku.jpg"));
        Sudo.setText("Sudoku");
        ...
        Loto.setIcon(new ImageIcon("src/Loto.jpg"));
        Loto.setText("Loto");
        p2.add(Loto);
        p2.add(espace2);
        ...
        Poker.setIcon(new ImageIcon("src/Poker.jpg"));
        Poker.setText("Poker");
        p2.add(Poker);
        p2.add(espace3);
        ...
        BN.setIcon(new ImageIcon("src/BN.jpg"));
        BN.setText("BN");
        p2.add(BN);
